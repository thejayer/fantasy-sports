...
`getProjectionSnapshot` (4.2); ESPN ID join (4.3) and hub UI (4.4) remain.
...
| 15 | `ffa` engine disconnected from the hub | P2 | Partly — 4.1–4.2 landed (CLI + snapshot contract); UI/ID join still 4.3–4.4 |
